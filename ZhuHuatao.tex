...
\end{itemize}
We summarize the main results in Table~\ref{tab:prima_rosenbrock_results}. The complete results are available in the file~\path{/path/to/prima_optiprofiler_test/results/prima_rosenbrock/prima_rosenbrock_results.mat}. 
